...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    using Usain.CommandListener.Commands;
    using Usain.CommandListener.Configuration;
    using Usain.CommandListener.Infrastructure.Hosting.Endpoints;
    using Usain.CommandListener.Infrastructure.Hosting.Endpoints.ResultGenerators;
    using Usain.CommandListener.Infrastructure.Hosting.Middlewares;
    using Usain.CommandListener.Infrastructure.Security;
    using Usain.Slack.Models.Events;
    using Usain.Slack.Security;
    using Endpoint =
        Usain.CommandListener.Infrastructure.Hosting.Endpoints.Endpoint;
